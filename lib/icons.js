...
const PATHS = {
  ...
  // Для строки быстрых метрик (Quick Metrics) бенто-карточки — оборот
  // бонуса как цикл, а не деньги и не время, чтобы не путать с clock/coins.
  repeat: '<path d="M4 12a8 8 0 0113.9-5.4M20 12a8 8 0 01-13.9 5.4"/><path d="M17 3v4h-4M7 21v-4h4"/>',
};
